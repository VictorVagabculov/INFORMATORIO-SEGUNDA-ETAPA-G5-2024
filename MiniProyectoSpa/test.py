...
def iniciar_temporizador():
    calcular_hora_salida()  # Actualiza la hora de salida al iniciar el temporizador
    actualizar_tiempo()
...
def agregar_tiempo(valor):
    ...
    label_tiempo.config(text=f"{horas:02}:{minutos:02}:{segundos:02}")
    calcular_hora_salida()  # Actualiza la hora de salida cada vez que se agrega tiempo
# ----------------------------------------------------------------------------------------------------------------------------------------------
